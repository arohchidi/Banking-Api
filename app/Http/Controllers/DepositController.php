...
class DepositController extends Controller
{
    ...
    public function fundAccount(Request $request){
        ...
        try {
            ...
            if($account_number){
                ...
                if($type_of_account == $request->type_of_account && $pin == $request->pin){
                    ...
                    //update the balance on the user table
                   ...
                   return response()->json(['error' => 'The type of account you choose  is not correct or your transaction pin is incorrect.'],403);
        ...
        return response()->json(['success' => 'You have successfully deposited '
           .' : '. $request->amount . '. Your new balance is ' .    $new_balance],200);
